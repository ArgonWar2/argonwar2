<?php
  /** A PHP class to access MySQL database with convenient methods
    ...
    * @version  1.1
    * @author   S&eacute;bastien Lao&ucirc;t (slaout@linux62.org) - Modified by Simone on Fri Oct 21, 2011
    */
  class DB
  {
    ...
    /** Connect to a MySQL database to be able to use the methods below.
      */
    function DB($server, $user, $pass)
    {
      $this->mtStart    = $this->getMicroTime();
      $this->nbQueries  = 0;
      $this->lastResult = NULL;
      mysql_connect($server, $user, $pass) or die("The Database is off. Actually we are working to resolve this issue. We apologize for the inconvenience. Please retry later.");
    }
